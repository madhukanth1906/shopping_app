    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`fixed bottom-6 right-6 z-[100] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-outline-variant/20 backdrop-blur-xl ${
